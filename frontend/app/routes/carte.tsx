            ...
            <div className="carte flex flex-col">
                ...
                .map(([arrivage, bieres]) => (
                    <div key={arrivage} className="w-full">
                        <h2 className="text-2xl font-bold text-primary text-center my-4">Arrivage du {new Date(arrivage).toLocaleDateString("fr", {
                            weekday: 'long',
                            year: 'numeric',
                            month: 'long',
                            day: 'numeric'
                        ...
                        <div className="flex flex-wrap justify-center">
                            {bieres.map((biere) => (
                                <div key={biere.id} className="flex flex-row items-center justify-center w-full max-w-md p-4 m-2">
